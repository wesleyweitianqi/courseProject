<template>
<div>
  <el-dialog :message="message" title="Course Edit" v-model="popShow" width="30%" center :show-close="false">
    <el-form :model="editData" ref="ruleFormRef">
      ...
      <el-form-item >
        ...
        <el-button type="primary" @click="confirmClick(editData)">Confirm</el-button>
      </el-form-item>
    </el-form>
  </el-dialog>
</div>
